    ...
    <>
      <div className="relative min-h-[40vh]">
        ...
        <Container className="relative">
          <div className="space-y-3 w-full lg:max-w-2xl mx-auto text-heading bg-white p-6 rounded-xl absolute -bottom-[200%] z-20">
      ...
      <div className="bg-heading [clip-path:polygon(100%_0,100%_85%,50%_100%,0_85%,0_0,50%_0)] lg:[clip-path:polygon(100%_0,100%_75%,50%_100%,0_75%,0_0,50%_0)]">
        <Container parentClass="pb-16 lg:pb-12 pt-16" className="">
